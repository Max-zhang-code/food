...
exports.main = async (event, context) => {
  ...
  try {
    ...
    return {
      success: true,
      dish: { _id: dish_id, ...dishDoc.data, status: 'approved', approved_by: OPENID, approved_at: new Date() },
    }
  } catch (e) {
    console.error('approveDish error:', e)
    return { code: 'APPROVE_FAILED', message: e.message }
  }
}
